...
@endif
                    <form class="form-horizontal form-label-left" novalidate method="POST" action="{{route('Student.store')}}">
@csrf
                      ...
                      <div class="item form-group">
                        ...
                        <input value="{{old('Fname')}}" type="text" name="Fname" placeholder="First Name" class="form-control col-md-7 col-xs-12" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" value="{{old('Lname')}}" name="Lname" placeholder="Last Name" class="form-control col-md-7 col-xs-12" >
                                                                     <span class="text-danger" >
